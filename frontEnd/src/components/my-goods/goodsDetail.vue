...
export default {
  ...
  methods: {
    ...
    onBuyClicked (e) {
      ...
      console.log(pModel)
      // this.$router.push({ path: `/buySingleProduct/1111` })
      this.$router.push({ path: '/user/buySingleProduct', params: { id: 1111 } })
      // this.$router.push({ path: `/buySingleProduct/${JSON.stringify(pModel)}` })
