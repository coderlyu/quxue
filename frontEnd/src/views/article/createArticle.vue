<template>
  <div class="article-edit">
    ...
    <div class="article-edit-bottom">
      <van-button type="info" size="large" @click="submitPublic">确定发表</van-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    createQuestion (type) {
      ...
      this.$store.dispatch('question/publicQuestion', this.question).then(data => {
        if (type === 0) {
          this.$toast.success('保存为草稿成功')
        } else {
